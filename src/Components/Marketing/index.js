    ...
    <section className='marketing-container'>
      <div className='marketing-container-main'>
        <div className='marketing-container-main-presentation'>
          <h2 className='marketing-container-main-presentation-title'>Notre stratégie</h2>
          <h3 className='marketing-container-main-presentation-subtitle'>E-commerce, site vitrine, blog</h3>
          <p className='marketing-container-main-presentation-text'>Nous sommes à votre écoute pour comprendre votre besoin et concrétiser votre projet</p>
        </div>
